...
//    }
//    __mmask16 operator!=(const vec & v) const {                  // Vector arithmetic (not equal)
//      return _mm512_cmp_ps_mask(data,v.data,_MM_CMPINT_NE);
//    }
//    vec operator-() const {                                     // Vector arithmetic (negation)
...
//      return temp;
//#else
//      return vec(_mm512_rsqrt14_ps(v.data));
//#endif
//    }
//    friend vec sin(const vec & v) {                             // Sine function
...
//    }
//    __mmask8 operator!=(const vec & v) const {                  // Vector arithmetic (not equal)
//      return _mm512_cmp_pd_mask(data,v.data,_MM_CMPINT_NE);
//    } 
//    vec operator-() const {                                     // Vector arithmetic (negation)
...
//      return out;
//#else
//      return vec(_mm512_rsqrt14_pd(v.data));
//#endif
//    }
//    friend vec sin(const vec & v) {                             // Sine function
...
//      return data < v.data;
//    }
//    Vec16fb operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }    
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//      return data < v.data;
//    }
//    Vec8db operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//      return data < v.data;
//    }
//    Vec8fb operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }    
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//      return data < v.data;
//    }
//    Vec4db operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//      return data < v.data;
//    }
//    Vec4fb operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//      return data <= v.data;
//    }
//    Vec2db operator!=(const vec & v) const {                    // Vector arithmetic (not equal)
//      return data != v.data;
//    }
//    vec operator-() const {                                     // Vector arithmetic (negation)
//      return vec(-data);
...
//#endif
//    }
//    friend vec sqrt(const vec & v) {                             // Sine function
//      return vec(sqrt(v.data));
//    }
//    friend vec sin(const vec & v) {                             // Sine function
//      return vec(sin(v.data));
//    }
