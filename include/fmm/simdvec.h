...
namespace exafmm {
  ...
  struct SIMD<T,D,16> {
    ...
    static inline T setIndexedBody(B_iter B, uint16_t* const& ids) {
      T v( B[ids[0]].X[D],B[ids[1]].X[D],B[ids[2]].X[D],B[ids[3]].X[D],
           B[ids[4]].X[D],B[ids[5]].X[D],B[ids[6]].X[D],B[ids[7]].X[D],
           B[ids[8]].X[D],B[ids[9]].X[D],B[ids[10]].X[D],B[ids[11]].X[D],
          B[ids[12]].X[D],B[ids[13]].X[D],B[ids[14]].X[D],B[ids[15]].X[D]);
      return v;
    }
...
#if EXAFMM_ACOUSTICS          
    static inline T setIndexedBody(B_iter B, uint16_t* const& ids) { 
      T v(std::real(B[ids[0]].SRC * B[ids[0]].QWEIGHT),std::real(B[ids[1]].SRC * B[ids[1]].QWEIGHT),
      std::real(B[ids[2]].SRC * B[ids[2]].QWEIGHT),std::real(B[ids[3]].SRC * B[ids[3]].QWEIGHT),
      std::real(B[ids[4]].SRC * B[ids[4]].QWEIGHT),std::real(B[ids[5]].SRC * B[ids[5]].QWEIGHT),
      std::real(B[ids[6]].SRC * B[ids[6]].QWEIGHT),std::real(B[ids[7]].SRC * B[ids[7]].QWEIGHT),
      std::real(B[ids[8]].SRC * B[ids[8]].QWEIGHT),std::real(B[ids[9]].SRC * B[ids[9]].QWEIGHT),
      std::real(B[ids[10]].SRC * B[ids[10]].QWEIGHT),std::real(B[ids[11]].SRC * B[ids[11]].QWEIGHT),
      std::real(B[ids[12]].SRC * B[ids[12] ].QWEIGHT),std::real(B[ids[13]].SRC * B[ids[13] ].QWEIGHT),
      std::real(B[ids[14]].SRC * B[ids[14] ].QWEIGHT),std::real(B[ids[15]].SRC * B[ids[15]].QWEIGHT));
      return v;
    }
#endif    
  };
...
#if EXAFMM_ACOUSTICS                      
    static inline T setIndexedBody(B_iter B, uint16_t* const& ids) { 
      T v(std::imag(B[ids[0]].SRC * B[ids[0]].QWEIGHT),std::imag(B[ids[1]].SRC * B[ids[1]].QWEIGHT),
      std::imag(B[ids[2]].SRC * B[ids[2]].QWEIGHT),std::imag(B[ids[3]].SRC * B[ids[3]].QWEIGHT),
      std::imag(B[ids[4]].SRC * B[ids[4]].QWEIGHT),std::imag(B[ids[5]].SRC * B[ids[5]].QWEIGHT),
      std::imag(B[ids[6]].SRC * B[ids[6]].QWEIGHT),std::imag(B[ids[7]].SRC * B[ids[7]].QWEIGHT),
      std::imag(B[ids[8]].SRC * B[ids[8]].QWEIGHT),std::imag(B[ids[9]].SRC * B[ids[9]].QWEIGHT),
      std::imag(B[ids[10]].SRC * B[ids[10]].QWEIGHT),std::imag(B[ids[11]].SRC * B[ids[11]].QWEIGHT),
      std::imag(B[ids[12]].SRC * B[ids[12] ].QWEIGHT),std::imag(B[ids[13]].SRC * B[ids[13] ].QWEIGHT),
      std::imag(B[ids[14]].SRC * B[ids[14] ].QWEIGHT),std::imag(B[ids[15]].SRC * B[ids[15]].QWEIGHT));
      return v;
    }
#endif
  };
  ...
  struct SIMD<T,6,16> {
    ...
    static inline T setIndexedBody(B_iter B, uint16_t* const& ids) {
      T v( B[ids[0]].PATCH,B[ids[1]].PATCH,B[ids[2]].PATCH,B[ids[3]].PATCH,
           B[ids[4]].PATCH,B[ids[5]].PATCH,B[ids[6]].PATCH,B[ids[7]].PATCH,
           B[ids[8]].PATCH,B[ids[9]].PATCH,B[ids[10]].PATCH,B[ids[11]].PATCH,
          B[ids[12]].PATCH,B[ids[13]].PATCH,B[ids[14]].PATCH,B[ids[15]].PATCH);
      return v;
    }
  };
  template<typename T>
  ...
  struct SIMD<T,6,2> {
    ...
    static inline T setIndexedBody(B_iter B, uint16_t* const& ids) {
      T v( B[ids[0]].PATCH,B[ids[1]].PATCH);
      return v;
    }
  };
#endif
